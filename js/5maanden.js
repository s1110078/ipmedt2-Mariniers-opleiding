window.onload = () => {
	...
	const schietBtn = document.getElementById('js--schietBtn');

	// Eind modal
	const backgroundEind = document.getElementById('js--background--eind');
	const modalEind = document.getElementById('js--modal--eind');
	const volgendeMaandBtn = document.getElementById('js--5maandenbtn--volgende');
	...
	document.getElementById('js--ingevoerdenaam-eind').innerHTML = ingevoerdenaam;
	...
	progressiebarVulling.style.width = '50%';
	...
	backgroundEind.style.display = 'none';
	modalEind.style.display = 'none';

	schietBtn.onclick = () => {
		document.getElementById('js--sound').play();
		backgroundEind.style.display = 'flex';
		modalEind.style.display = 'block';
		localStorage.setItem('test4', false);
	};
